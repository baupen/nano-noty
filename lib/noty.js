...
/* harmony export */   createAudioElements: () => (/* binding */ createAudioElements),
...
function createAudioElements(ref) {
  if (ref.hasSound) {
    ...
    ref.options.sounds.sources.forEach(function (s) {
      ...
      source.src = s;
      source.type = "audio/".concat(getExtension(s));
...
var Noty = /*#__PURE__*/function () {
  ...
  return _createClass(Noty, [{
    ...
    value: function show() {
      ...
      var queueCounts = api__WEBPACK_IMPORTED_MODULE_2__.Queue.queue.length;
      ...
      utils__WEBPACK_IMPORTED_MODULE_1__.addListener(this.barDom, 'click', function (e) {
        utils__WEBPACK_IMPORTED_MODULE_1__.stopPropagation(e);
        _this.close();
      }, false);
      if (this.options.timeout) utils__WEBPACK_IMPORTED_MODULE_1__.addClass(this.barDom, 'noty_has_timeout');
    ...
    value: function overrideDefaults(obj) {
      api__WEBPACK_IMPORTED_MODULE_2__.Defaults = utils__WEBPACK_IMPORTED_MODULE_1__.deepExtend({}, api__WEBPACK_IMPORTED_MODULE_2__.Defaults, obj);
      return this;
    }
